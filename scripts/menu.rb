    ...
    @buttons = [
      {
        ...
        :active => false,
        :code => lambda do
          @window.game = Game.new(@window)
        end
      },
      {
        :on => Gosu::Image.new(@window, "images/button_highscore_on.png", true),
        :off => Gosu::Image.new(@window, "images/button_highscore_off.png", true),
        :active => false,
        :code => lambda do
          @window.highscore = Highscore.new(@window); @window.state = :highscore
        end
      },
      {
